...
export function Footer() {
    return (
        <section className="bg-[#00aaff] py-16 text-white">
            <div className="container mx-auto px-4">
                ...
                <footer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 mt-5">
                    <div>
                        ...
                        <p className="mb-4">Cuidando do seu melhor amigo(a) com amor e dedicação.</p>
                        <a
                        target='_blank'
                    ...
                    <div>
                        ...
                        <p >Telefone: (11) 991493011</p>
                        <p>Rua Girassol, 230 - Vl. Madalena - SP </p>
